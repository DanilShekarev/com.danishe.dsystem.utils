...
{
    public abstract class CustomInputModule : PointerInputModule
    {
        ...
        protected void ProcessMouseEvent(int id)
        {
            ...
            var newObject = leftButtonData.buttonData.pointerCurrentRaycast.gameObject;
            if (newObject != m_CurrentFocusedGameObject)
            {
                m_CurrentFocusedGameObject = newObject;
        ...
        protected abstract void OnObjectChanged(GameObject newObject);

        protected virtual bool OnCheckBlock() => false;
